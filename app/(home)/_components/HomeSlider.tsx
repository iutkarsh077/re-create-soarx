          ...
          <div className="sm:mt-10 mt-20">
            <div className="flex items-center gap-2 pt-16">
              ...
              <div className="text-center text-[#4BA492] dark:text-[#4BA492] cursor-pointer">
                {"Engage, Innovate, Elevate".split("").map((child, idx) => (
                  <span
                    className={"hoverText sm:text-[23px] text-[18px] "}
                    key={idx}
                  >
                    {child}
                  </span>
            ...
            <p className="pt-5  text-[20px] lg:text-[25px] min-[1400px]:text-[35px] text-slate-500">
              A nationwide community committed to igniting the potential of
              students through engaging events, sessions, and hackathons.
            </p>
            <button className=" signInbut mt-10">
              <Link
                href="https://chat.whatsapp.com/CcJFFC99PJv4iJnNvog2Jf"
                className="text-xl"
              >
                Join Us
              </Link>
